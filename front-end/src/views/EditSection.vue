<template>
  ...
  <div class="font-Roboto text-[#535353] mx-4 md:mx-[150px] lg:mx-[270px] mt-4 lg:mt-9 mb-2">
    <header class="flex justify-between mb-4 md:mb-0">
      <h2 class="font-bold text-xl mb-2">Edit Section</h2>
      <Vbutton :buttonNames="'HAPUS SECTION'" class="bg-[red]" />
    </header>
  ...
  <Vbutton :buttonNames="'SIMPAN'" class="font-medium md:w-[100px] ml-4 md:ml-[150px] lg:ml-[270px] mb-10" />
</template>
